...
-- Tabela adicionada para registrar as respostas dos alunos e a correcao/feedback gerado pela IA
CREATE TABLE respostas (
  ...
  criado_em     TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  CONSTRAINT fk_resposta_aluno FOREIGN KEY (aluno_id) REFERENCES usuarios(id),
  CONSTRAINT fk_resposta_questao FOREIGN KEY (questao_id) REFERENCES questoes(id)
) ENGINE=InnoDB;
